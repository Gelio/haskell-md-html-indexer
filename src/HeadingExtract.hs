module HeadingExtract (getResourceHeadings, getResourceHeadingsTrimmed) where
...
getResourceHeadingsTrimmed s = getResourceHeadings s .| mapC strip .| filterC (not . T.null)
